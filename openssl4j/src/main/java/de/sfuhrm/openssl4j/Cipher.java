...
public class Cipher {
  ...
  public static final class AES_256 extends OpenSSLCipherNative {
    public AES_256() {
      super("AES-256");
    }
  }
  ...
  public static final class AES_128_ECB extends OpenSSLCipherNative{
    public AES_128_ECB() {
      super("AES_128_ECB");
    }
  }
  ...
  public static final class AES_512_ECB extends OpenSSLCipherNative{
    public AES_512_ECB() {
      super("AES_512_ECB");
    }
  }

  public static final class AES_ECB extends OpenSSLCipherNative{
    public AES_ECB() {
      super("AES_256_ECB");
    }
  }
